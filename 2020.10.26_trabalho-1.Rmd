...
??? manter o tamanho do terreno que está no dataframe?
...
Isso sugere que o comprador pagou menos do que o previsto no modelo, uma vez que o resíduo diz respeito à diferença entre o valor observado e o valor previsto.
...
* $\beta_{0} = 4.6209$ deveria corresponder ao valor estimado do salário anual caso o valor das vendas e o valor de mercado da firma sejam simultaneamente iguais a zero.

<!-- complementar! parece muito improvável o valor de vendas e o valor de mercado chegarem a zero... falência? -->

* $\beta_{1} = 0.1621$ indica, caso o valor de mercado permaneça o mesmo (ceteris paribus), que o aumento de $1 nas vendas da firma resulta em um aumento de 16.21% do salário anual, o que pode ser interpretado como:

$$ \% \Delta salario = 16.21\% \Delta vendas $$

* $\beta_{2} = 0.1067$ indica, caso o valor das vendas  permaneça o mesmo (ceteris paribus), que o aumento de $1 no valor de mercado da firma resulta em um aumento de 10.67% do salário anual, o que pode ser interpretado como:

$$ \% \Delta salario = 10.67\% \Delta valmercado $$
...
Ou seja, um aumento de permanência e idade em 1 ano resultaria em um aumento de 0.018614% no salário anual.
