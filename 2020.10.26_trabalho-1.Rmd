...
Outras variáveis que potencialmente afetam a variável resposta são: nível de escolaridade, desempenho escolar, raça, gênero, vocação, habilidades técnicas, habilidades sociais, criatividade, lucros da empresa, área de atuação, porte e localização da empresa, PIB do país. Fatores individuais inatos como raça, gênero e idade, estão intimamente relacionados com variáveis como nível de escolaridade, desempenho escolar e desenvolvimento de habilidades técnicas e sociais e criatividade. Além disso, as características de localização, porte e área de atuação da empresa, por exemplo, tem ligação com seu valor de mercado, vendas anuais e lucros.
